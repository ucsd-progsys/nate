...
\addplot [forget plot,draw=none] coordinates{
  ...
  (op+context+type+size/linear,0)
  (op+context+type+size/decision-tree,0)
  (op+context+type+size/random-forest,0)
  (op+context+type+size/hidden-10,0)
  (op+context+type+size/hidden-500,0)
};
}
\makeatother
