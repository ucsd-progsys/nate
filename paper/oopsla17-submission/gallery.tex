...
%
(3) the prediction of our \dectree classifier (\underline{underlined}), and
%
...
%
For these programs we will additionally \colorbox{red!50}{highlight} the
...
\begin{ecode}
  let rec clone x n =
    let rec loop (*@\colorbox{red!50}{x n acc}@*) =
      if n < 0 then
        acc
      else
...
crucial observation is that the parent of the recursive call is a data
