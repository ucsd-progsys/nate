...
\pgfplotstableread{../../data/sp14/baseline.csv}{\FeatureBench}
\pgfplotstablevertcat{\FeatureBench}{../../data/sp14/op+type+size/linear/results.csv}
\pgfplotstablevertcat{\FeatureBench}{../../data/sp14/op+context+type+size/linear/results.csv}
\pgfplotstablevertcat{\FeatureBench}{../../data/sp14/op+context-has+type+size/linear/results.csv}
\pgfplotstablevertcat{\FeatureBench}{../../data/sp14/op+context-count+type+size/linear/results.csv}
\pgfplotstablevertcat{\FeatureBench}{../../data/sp14/op+type+size/hidden-500/results.csv}
\pgfplotstablevertcat{\FeatureBench}{../../data/sp14/op+context+type+size/hidden-500/results.csv}
\pgfplotstablevertcat{\FeatureBench}{../../data/sp14/op+context-has+type+size/hidden-500/results.csv}
\pgfplotstablevertcat{\FeatureBench}{../../data/sp14/op+context-count+type+size/hidden-500/results.csv}
...
\addplot table[x=tool, y=top-1] {\HiddenBench};
\addplot table[x=tool, y=top-2] {\HiddenBench};
\addplot table[x=tool, y=top-3] {\HiddenBench};
