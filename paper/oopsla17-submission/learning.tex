...
models~\cite{FIXME,FIXME}.
% FIXME: cite "on the naturalness of software" and "on the uniqueness of
% software" at the very least for the above
...
the type $\tint$.
%
We rely on the model to counteract this bias (see FIXME reference to later
in the paper). 
