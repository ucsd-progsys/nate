...
** FROM KAMALIKA
*** OVERVIEW
   - point (2) in "key tech challenges": phrasing in CHALLENGE 2 is much
     clearer
   - challenge 1: make it clear that we're specifically interested in
     representations for LOCALIZING TYPE ERRORS
     - and tie in from SOLUTION
   - challenge 2: want blame assignment that is USEFUL and PREDICTABLE
   - challenge 3: phrase challenge in terms of INTUITIVE PRESENTATION
*** LEARNING > LABELS
