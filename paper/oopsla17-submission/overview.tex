...
\emph{supervised classification} problem~\cite{FIXME}. 
% Give a generic citation for supervised classification, such as an ML
% textbook or seminal ML paper or survey, above.
%
...
programs and determine the ``correct'' fix (e.g.,~\cite{FIXME,FIXME}), but
...
(e.g., via statistics FIXME: cite Engler's z-ranking paper, etc.); we focus
