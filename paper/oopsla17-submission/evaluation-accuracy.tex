...
\item[\dectree] A decision tree trained with the \ES{HUMA?} algorithm and \ES{HUMA: hyperparams?}.
\item[\forest] A random forest trained with the \ES{HUMA?} algorithm and 30 estimators \ES{HUMA: hyperparams?}.
