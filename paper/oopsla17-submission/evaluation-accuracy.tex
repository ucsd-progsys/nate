...
\item A decision tree trained with the \ES{HUMA?} algorithm and \ES{HUMA: hyperparams?}.
\item A random forest trained with the \ES{HUMA?} algorithm and 30 estimators \ES{HUMA: hyperparams?}.
...
optimizer \ES{CITE}, a variant of stochastic gradient descent that has
